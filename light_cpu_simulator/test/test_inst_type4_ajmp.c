...
#undef  TESTNAME
#define TESTNAME inst_type4_ajmp
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_NE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_NE, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_NE, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_NE, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_CS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_CS, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_CS, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_CS, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_CC_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_CC, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_CC, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_CC, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_MI_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_MI, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_MI, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_MI, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_PL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_PL, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_PL, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_PL, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_VS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_VS, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_VS, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_VS, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_VC_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_VC, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_VC, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_VC, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_HI_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_HI, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_HI, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    
    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_HI, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_LS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_LS, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_LS, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_LS, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_GE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_GE, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_GE, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_GE, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_LT_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_LT, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_LT, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_LT, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_GT_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_GT, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_GT, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_GT, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_LE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_LE, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_LE, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_LE, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_AL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_AL, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_AL, RD, 5); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_AL, RD, 9); //should jump 
...
SET_TEST(TESTNAME, test_ajmp_without_link_under_RSV_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMP(InstMem[1], COND_RSV, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[3], 20, 10);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE4_AJMP(InstMem[5], COND_RSV, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE4_AJMP(InstMem[9], COND_RSV, RD, 9); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_ajmp_with_link_under_AL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE4_AJMPL(InstMem[1], COND_AL, RD, 1); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);
