...
#undef  TESTNAME
#define TESTNAME inst_type3_rjmp
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_NE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_NE, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_NE, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_NE, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_CS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_CS, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_CS, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_CS, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_CC_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_CC, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_CC, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_CC, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_MI_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_MI, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_MI, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_MI, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_PL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_PL, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_PL, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_PL, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_VS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_VS, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_VS, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_VS, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_VC_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_VC, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_VC, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_VC, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_HI_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_HI, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_HI, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    
    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_HI, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_LS_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_LS, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_LS, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_LS, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_GE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_GE, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_GE, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_GE, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_LT_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_LT, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_LT, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[6], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_LT, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_GT_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_GT, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_GT, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_GT, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_LE_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_LE, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_LE, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_LE, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_AL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_AL, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_AL, 2); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_AL, 2); //should jump 
...
SET_TEST(TESTNAME, test_rjmp_without_link_under_RSV_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_RSV, 10); //should not jump 
    SET_TYPE1_MOVE(InstMem[3], 20, 10);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_RSV, 6); //should not jump 
    SET_TYPE1_MOVE(InstMem[7], 21, 11);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_RSV, 2); //should not jump 
    SET_TYPE1_MOVE(InstMem[10], 22, 12);
    SET_ERROR_INST(InstMem[11]);
...
SET_TEST(TESTNAME, test_rjmp_with_link_under_AL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMPL(InstMem[1], COND_AL, 2); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);
...
SET_TEST(TESTNAME, test_rjmp_ahead_without_link_under_AL_condition)
{
    ...
    //write instrction memory
    SET_TYPE1_CMP(InstMem[0], 0, 1);
    SET_TYPE3_RJMP(InstMem[1], COND_AL, 6); //should jump 
    SET_ERROR_INST(InstMem[2]);
    SET_TYPE1_MOVE(InstMem[3], 20, 10);

    SET_TYPE1_CMP(InstMem[4], 2, 3);
    SET_TYPE3_RJMP(InstMem[5], COND_AL, 6); //should jump 
    SET_ERROR_INST(InstMem[6]);
    SET_TYPE1_MOVE(InstMem[7], 21, 11);

    SET_TYPE1_CMP(InstMem[8], 4, 5);
    SET_TYPE3_RJMP(InstMem[9], COND_AL, (unsigned int)(-6)); //should jump 
    SET_ERROR_INST(InstMem[10]);
    SET_TYPE1_MOVE(InstMem[11], 22, 12);
