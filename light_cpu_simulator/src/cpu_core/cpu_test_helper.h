...
#define SET_TYPE1_LD_4_BYTE(ch, RD, RB, RA)		        SET_TYPE1_INSTRUCTION(ch, OP_LD, 1, 0, 0, 0, 0, RD, RB, RA)
...
#define SET_TYPE1_ST_4_BYTE(ch, RD, RB, RA)		        SET_TYPE1_INSTRUCTION(ch, OP_ST, 1, 0, 0, 0, 0, RD, RB, RA)
